...
def start():
    ...
    while iteration < count:
        ...
        try:
            requests.post("https://www.monomax.me/api/v2/signup/telno"  json={"phone": _phone9, "name": "Олег", "is_terms_accepted": "true"})
